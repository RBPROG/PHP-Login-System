...
if (isset($_POST['signupsubmit'])) {
    ...
    */
    ...
    $rol = input_filter($_POST['role']);
    $hospital = input_filter($_POST['hospital']);
    ...
    */
    ...
    if (empty($username) || empty($email) || empty($password) || empty($passwordRepeat)) {
        ...
        */
        ...
        $sql = "insert into users(username, email, password, first_name, last_name, userRole, userHospital, gender, 
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            mysqli_stmt_bind_param($stmt, "ssssssssss", $username, $email, $hashedPwd, $full_name, $last_name, $rol, $hospital, $gender, $headline, $bio, $FileNameNew);
            ...
            */
            ...
            header("Location: ../../investigadores/");
            exit();
        }
    }
